...
class VideoControllerTest extends TestCase
{
    ...
    public function testInvalidationVideoField()
    {
        $this->assertInvalidationFile(
            'video_file', 'mp4', 15, 'mimetypes', ['values' => 'video/mp4']
        );
    }
    ...
    public function testStoreFiles()
    {
        ...
        $response = $this->json('POST', $this->routeStore(), $this->sendData + ['categories_id' => [$category->id], 'genres_id' => [$genre->id]] + $files);
    ...
    public function testUpdateFiles()
    {
        ...
        $response = $this->json('PUT', $this->routeUpdate(), $this->sendData + ['categories_id' => [$category->id], 'genres_id' => [$genre->id]] + $files);
