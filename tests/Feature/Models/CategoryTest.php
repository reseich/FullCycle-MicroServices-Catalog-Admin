...
class CategoryTest extends TestCase
{
    ...
    public function testList()
    {
        ...
        $this->assertEqualsCanonicalizing(['id', 'name', 'description', 'is_active', 'created_at', 'updated_at', 'deleted_at'], $categoryKey);
    }
    ...
    public function testCreate()
    {
        ...
        $this->assertNull($category->description);
        $category = Category::create(['name' => 'test1', 'description' => 'test_descriptions']);
    ...
    {
        $category = factory(Category::class)->create(['name' => 'test_name']);
        self::assertTrue(Uuid::isValid($category->id));
    }

    public function testDelete()
    {
        $category = factory(Category::class)->create(['name' => 'test_name', 'description' => 'test_description']);
        $category->delete();
        $categories = Category::all();
